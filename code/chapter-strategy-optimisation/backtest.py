...
class Backtest(object):
    ...
    def __init__(
        ...
        strat_params_dict = dictionary of strategy parameters.
        """
    ...
    def _generate_trading_instances(self):
        ...
        """
        print(
            "Creating DataHandler, Strategy, Portfolio and "
            "ExecutionHandler for strategy parameter "
            "list: %s..." % self.strat_params_dict
        )
        self.data_handler = self.data_handler_cls(
            self.events, self.csv_dir, self.symbol_list
        )
        self.strategy = self.strategy_cls(
            self.data_handler, self.events, **self.strat_params_dict
        )
    ...
    def simulate_trading(self):
        ...
        return tot_ret, sharpe, max_dd, dd_dur
